        ...
        <div className="grid grid-cols-1 items-center lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8 mx-auto">
            ...
            <div className="space-y-6 text-[var(--foreground-color)]">
              <h1 className="text-[27px] sm:text-3xl md:text-4xl lg:text-5xl font-neue-ultraBold md:leading-13 mb-4 md:mb-8 lg:mb-12 text-center lg:text-left">
                Our <span className="underline">Projects</span>
                <br className="hidden lg:block"/>
                <span className="lg:hidden"> </span>and <span className="underline">Vision</span>
              </h1>
            ...
            {/* Specialties Card */}
            <div className="bg-[var(--primary-color)]/17 text-[var(--foreground-color)] max-w-lg mx-auto rounded-lg p-5 md:p-8 relative">
              {/* Specialties heading */}
          ...
          <div className="space-y-6 mx-auto text-[var(--foreground-color)]">
            {projects.map(({ id, title, description }) => (
              <div className="sm:grid sm:grid-cols-16 bg-[var(--primary-color)]/35 max-w-lg rounded-lg sm:ps-2 sm:pe-6 p-5 sm:py-8 relative">
